...
/** Google Gemini's asymmetric four-lobed spark, kept separate from generic sparkle icons. */
export function GeminiIcon({ size = 18, ...props }: ProviderIconProps) {
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id={gradientId} x1="22" y1="170" x2="170" y2="22" gradientUnits="userSpaceOnUse">
          <stop stopColor="#3186FF" />
          <stop offset="0.5" stopColor="#7C9CFF" />
